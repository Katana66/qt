...
void Widget::on_durationChanged(qint64 duration)
{
    ...
    ui->labelDuration->setText(QString("Duration:").append(qt_duration.toString(qt_duration.toString(duration<3600000 ? "mm:ss": "hh:mm:ss"))));
...
void Widget::on_position_changed(qint64 position)
{
    ...
    ui->labelProgress->setText(QString("Progress:").append(qt_position.toString(qt_position.toString(position<3600000 ? "mm:ss": "hh:mm:ss"))));
...
void Widget::on_current_index_changed(int position)
{
    ...
    ui->labelFile->setText(QString("Song file:").append(song->text()));
}
